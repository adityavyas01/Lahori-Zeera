...
export default function TextOverlay({ variant, isSwitching }: TextOverlayProps) {
  return (
    <div className="flex-grow md:col-span-3 flex flex-col justify-center h-full relative text-center md:text-left">
       <div className="absolute inset-0 -left-8 -right-8 md:-left-16 md:-right-1/2 bg-gradient-to-r from-black/70 via-black/50 to-transparent" />
      <div
        className={cn(
      ...
      >
        <h1 className="font-headline text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-bold uppercase tracking-tighter text-white">
          {variant.name}
        </h1>
        <p className="font-body text-base sm:text-lg md:text-xl font-bold uppercase tracking-widest text-primary">
          {variant.subtitle}
        </p>
        <p className="font-body text-sm sm:text-base md:text-lg max-w-md text-balance text-white/80 mx-auto md:mx-0">
          {variant.description}
        </p>
