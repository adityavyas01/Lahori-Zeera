    ...
    return (
        <SectionWrapper id="flavors" className="bg-secondary/20">
            <div className="text-center mb-12">
                <h2 className="font-headline text-5xl md:text-6xl font-bold text-foreground">Our Flavors</h2>
                ...
                {variants.map((variant, index) => {
                    ...
                    return (
                        <Card key={variant.id} className={cn("border-2 text-center", variant.themeClass)} style={{borderColor: variant.themeColor}}>
                            <CardHeader>
                                <CardTitle className="font-headline text-4xl font-bold" style={{color: variant.themeColor}}>{variant.name}</CardTitle>
                                <p className="font-bold uppercase tracking-widest" style={{color: variant.themeColor}}>{variant.subtitle}</p>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <p className="text-muted-foreground italic">"{data?.vibe}"</p>
                                <div>
                                    <h4 className="font-bold text-foreground">The Mix:</h4>
                                    <p className="text-muted-foreground">{data?.mix}</p>
                                </div>
                            </CardContent>
                        </Card>
                    )
